...
/// today. <see cref="SimpleTest.Resolve"/> and <see cref="OpposedTest.Resolve"/> are the
/// only two operations under <c>Deckard.Rules</c> that currently accept one, and both are
/// total once their arguments validate (ADR 0011): every unresolved-or-invalid path
/// either can produce is a thrown <see cref="ArgumentException"/>, not an
/// <see cref="UnresolvedTestResult"/> branch.
/// </summary>
