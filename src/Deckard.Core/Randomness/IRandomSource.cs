...
public interface IRandomSource
{
    ...
    /// <see cref="Deckard.Core.Dice.D6.Roll(IRandomSource)"/>) terminate rather than loop
    ...
    /// (tests/Deckard.Testing) is the existing example: it does not pretend to be uniform,
